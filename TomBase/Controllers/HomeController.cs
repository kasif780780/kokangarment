...
namespace BasePackageModule2.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var banner = await _context.Banners.Take(2).ToListAsync();
            ...
            var youmayLike = await _context.Products.OrderBy(o => o.Id).Take(4).ToListAsync();
            ...
            var onSaller = await _context.Products.OrderBy(d => d.Id).ToListAsync();
            var topSalling = await _context.Products.OrderBy(d => d.Id).ToListAsync();
