        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisteredContactNumber = table.Column<string>(nullable: false),
                    AlternateContactNumber = table.Column<string>(nullable: true),
                    DisplayContact1 = table.Column<string>(nullable: true),
                    DisplayContact2 = table.Column<string>(nullable: true),
                    DisplayContact3 = table.Column<string>(nullable: true),
                    Address = table.Column<string>(nullable: false),
                    City = table.Column<string>(nullable: false),
                    State = table.Column<string>(nullable: false),
                    Country = table.Column<string>(nullable: false),
                    Pincode = table.Column<string>(nullable: false),
                    WhatsAppForBusinessNumber = table.Column<string>(nullable: true),
                    FacebookPageURL = table.Column<string>(nullable: true),
                    InstagramPageURL = table.Column<string>(nullable: true),
                    TwitterURL = table.Column<string>(nullable: true),
                    LinkedInURL = table.Column<string>(nullable: true),
                    YoutubeURL = table.Column<string>(nullable: true),
                    OtherWebsite = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlternetPhone = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OgUrl = table.Column<string>(nullable: true),
                    OgSiteName = table.Column<string>(nullable: true),
                    MetaTwitter = table.Column<string>(nullable: true),
                    MetaTwitterDescription = table.Column<string>(nullable: true),
                    TwitterTitle = table.Column<string>(nullable: true),
                    MsValidate = table.Column<string>(nullable: true),
                    GSiteVerivation = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
